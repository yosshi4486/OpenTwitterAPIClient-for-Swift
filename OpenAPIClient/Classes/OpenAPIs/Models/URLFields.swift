...
public struct URLFields: Codable {
    ...
    public init(url: String, expandedUrl: String? = nil, displayUrl: String? = nil, unwoundUrl: String? = nil, status: Int? = nil, title: String? = nil, description: String? = nil, images: [URLImage]? = nil) {
        self.url = url
